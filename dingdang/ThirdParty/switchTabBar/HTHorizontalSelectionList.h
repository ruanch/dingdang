...
@property (nonatomic,assign) double HTHorizontalSelectionListInternalPadding;
@property (nonatomic,assign) double HTHorizontalSelectionListHorizontalMargin;
...
- (UIButton *)selectionList:(HTHorizontalSelectionList *)selectionList titleForItemWithIndex:(NSInteger)index ;
